...
<div class="container">
	<h1 class="page-header text-center">PLACE YOUR ORDER</h1>
				...
				<?php 
					...
					while($row=$query->fetch_array()){
						...
						<tr>
							...
							<td class="text-right">SHS <?php echo number_format($row['price'], 2); ?></td>
...
<footer><center>SENKUBUGE PETER ALLAN | MIS | 2019-M132-20012</center></footer>
</html>